...
using C_SallesWebMVC.Models.Enums;
using System.Linq;
...
namespace C_SallesWebMVC.Data
{
    ...
    {
        private C_SalesWebMVCContext _context;
        public SeedingService(C_SalesWebMVCContext context)
        {
            _context = context;
        }
        public void Seed()
        {
            if (_context.Department.Any() ||
                 _context.Seller.Any() || 
                 _context.SalesRecord.Any())   //Operação "Any" testa se ja existe algum registro nessas tabelas
           {
                return; //Db ja foi pupulada
            }
